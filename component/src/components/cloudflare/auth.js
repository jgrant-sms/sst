...
var Auth = /** @class */ (function (_super) {
    ...
    function Auth(name, args, opts) {
        ...
        _this._authenticator = (0, pulumi_1.output)(args.authenticator).apply(function (args) {
            return new worker_1.Worker("".concat(name, "Authenticator"), __assign(__assign({}, args), { url: true, environment: __assign(__assign({}, args.environment), { AUTH_PRIVATE_KEY: (0, pulumi_1.secret)(_this.key.privateKeyPemPkcs8), AUTH_PUBLIC_KEY: (0, pulumi_1.secret)(_this.key.publicKeyPem) }) }));
        });
        return _this;
    }
...
exports.Auth = Auth;
var __pulumiType = "sst:cloudflare:Auth";
// @ts-expect-error
