...
exports.BucketQueueSubscriber = void 0;
 ...
 */
var BucketQueueSubscriber = /** @class */ (function (_super) {
    __extends(BucketQueueSubscriber, _super);
    function BucketQueueSubscriber(name, args, opts) {
        var _this = _super.call(this, __pulumiType, name, args, opts) || this;
        var self = _this;
        var queueArn = (0, pulumi_1.output)(args.queue);
    ...
    Object.defineProperty(BucketQueueSubscriber.prototype, "nodes", {
        /**
    ...
    return BucketQueueSubscriber;
}(component_1.Component));
exports.BucketQueueSubscriber = BucketQueueSubscriber;
var __pulumiType = "sst:aws:BucketQueueSubscriber";
// @ts-expect-error
