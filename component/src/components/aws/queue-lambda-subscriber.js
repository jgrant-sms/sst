...
exports.QueueLambdaSubscriber = void 0;
 ...
 */
var QueueLambdaSubscriber = /** @class */ (function (_super) {
    __extends(QueueLambdaSubscriber, _super);
    function QueueLambdaSubscriber(name, args, opts) {
        var _this = _super.call(this, __pulumiType, name, args, opts) || this;
        var self = _this;
        var queue = (0, pulumi_1.output)(args.queue);
        ...
        function createEventSourceMapping() {
            ...
            return new ((_a = aws_1.lambda.EventSourceMapping).bind.apply(_a, __spreadArray([void 0], (0, component_1.transform)((_b = args.transform) === null || _b === void 0 ? void 0 : _b.eventSourceMapping, "".concat(name, "EventSourceMapping"), {
                functionResponseTypes: (0, pulumi_1.output)(args.batch).apply(function (batch) {
                    return (batch === null || batch === void 0 ? void 0 : batch.partialResponses) ? ["ReportBatchItemFailures"] : [];
                }),
                batchSize: (0, pulumi_1.output)(args.batch).apply(function (batch) { var _a; return (_a = batch === null || batch === void 0 ? void 0 : batch.size) !== null && _a !== void 0 ? _a : 10; }),
                maximumBatchingWindowInSeconds: (0, pulumi_1.output)(args.batch).apply(function (batch) {
                    return (batch === null || batch === void 0 ? void 0 : batch.window) ? (0, duration_1.toSeconds)(batch.window) : 0;
                }),
    ...
    Object.defineProperty(QueueLambdaSubscriber.prototype, "nodes", {
        /**
    ...
    return QueueLambdaSubscriber;
}(component_1.Component));
exports.QueueLambdaSubscriber = QueueLambdaSubscriber;
var __pulumiType = "sst:aws:QueueLambdaSubscriber";
// @ts-expect-error
