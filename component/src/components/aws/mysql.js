...
var Mysql = /** @class */ (function (_super) {
    ...
    function Mysql(name, args, opts) {
        ...
        var engineVersion = (0, pulumi_1.output)(args.version).apply(function (v) { return v !== null && v !== void 0 ? v : "8.0.40"; });
        var instanceType = (0, pulumi_1.output)(args.instance).apply(function (v) { return v !== null && v !== void 0 ? v : "t4g.micro"; });
        var username = (0, pulumi_1.output)(args.username).apply(function (v) { return v !== null && v !== void 0 ? v : "root"; });
        ...
        function reference() {
            ...
            var input = instance.tags.apply(function (tags) {
                return {
                    ...
                    passwordTag: tags === null || tags === void 0 ? void 0 : tags["sst:ref:password"],
                };
            });
            ...
            var password = input.passwordTag.apply(function (passwordTag) {
                if (!passwordTag)
                    throw new error_1.VisibleError("Failed to get password for MySQL ".concat(name, "."));
        ...
        function normalizeStorage() {
            ...
            return (0, pulumi_1.output)((_a = args.storage) !== null && _a !== void 0 ? _a : "20 GB").apply(function (v) {
                ...
                if (size < 20) {
                    throw new error_1.VisibleError("Storage must be at least 20 GB for the ".concat(name, " MySQL database."));
                }
                if (size > 65536) {
                    throw new error_1.VisibleError("Storage cannot be greater than 65536 GB (64 TB) for the ".concat(name, " MySQL database."));
                }
                return size;
            });
        }
        ...
        function registerDev() {
            ...
            if ($dev &&
                ...
                throw new error_1.VisibleError("You must provide the password to connect to your locally running MySQL database either by setting the \"dev.password\" or by setting the top-level \"password\" property.");
            }
            var dev = {
                enabled: $dev,
                host: (0, pulumi_1.output)((_a = args.dev.host) !== null && _a !== void 0 ? _a : "localhost"),
                port: (0, pulumi_1.output)((_b = args.dev.port) !== null && _b !== void 0 ? _b : 3306),
            ...
            new dev_command_js_1.DevCommand("".concat(name, "Dev"), {
                ...
                environment: {
                    SST_DEV_COMMAND_MESSAGE: (0, pulumi_1.interpolate)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Make sure your local MySQL server is using:\n\n  username: \"", "\"\n  password: \"", "\"\n  database: \"", "\"\n\nListening on \"", ":", "\"..."], ["Make sure your local MySQL server is using:\n\n  username: \"", "\"\n  password: \"", "\"\n  database: \"", "\"\n\nListening on \"", ":", "\"..."])), dev.username, dev.password, dev.database, dev.host, dev.port),
                },
            });
            return dev;
        }
        ...
        function createParameterGroup() {
            ...
            return new ((_a = aws_1.rds.ParameterGroup).bind.apply(_a, __spreadArray([void 0], (0, component_1.transform)((_b = args.transform) === null || _b === void 0 ? void 0 : _b.parameterGroup, "".concat(name, "ParameterGroup"), {
                family: engineVersion.apply(function (v) {
                    var _a = v.split("."), major = _a[0], minor = _a[1], _patch = _a[2];
                    return "mysql".concat(major, ".").concat(minor);
                }),
                parameters: [
                    {
        ...
        function createInstance() {
            ...
            return new ((_a = aws_1.rds.Instance).bind.apply(_a, __spreadArray([void 0], (0, component_1.transform)((_b = args.transform) === null || _b === void 0 ? void 0 : _b.instance, "".concat(name, "Instance"), {
                ...
                performanceInsightsEnabled: instanceType.apply(function (v) { return !v.endsWith(".micro") && !v.endsWith(".small"); }),
                tags: {
    ...
    Object.defineProperty(Mysql.prototype, "id", {
        /**
    ...
    Object.defineProperty(Mysql.prototype, "proxyId", {
        /**
    ...
    Object.defineProperty(Mysql.prototype, "username", {
    ...
    Object.defineProperty(Mysql.prototype, "password", {
    ...
    Object.defineProperty(Mysql.prototype, "database", {
        /**
    ...
    Object.defineProperty(Mysql.prototype, "port", {
        /**
    ...
    Object.defineProperty(Mysql.prototype, "host", {
        /**
    ...
    Object.defineProperty(Mysql.prototype, "nodes", {
        get: function () {
            return {
    ...
    /** @internal */
    Mysql.prototype.getSSTLink = function () {
        return {
            properties: {
     ...
     * ```
     */
    Mysql.get = function (name, args, opts) {
...
exports.Mysql = Mysql;
var __pulumiType = "sst:aws:Mysql";
// @ts-expect-error
